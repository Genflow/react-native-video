...
RCT_EXPORT_VIEW_PROPERTY(isExternalMusicDucked, BOOL);
...
RCT_EXPORT_VIEW_PROPERTY(onVideoUncontrolledFocusLost, RCTBubblingEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onVideoUncontrolledDuckLost, RCTBubblingEventBlock);
